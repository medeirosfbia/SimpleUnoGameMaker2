...
function createTabs() {
	if (!obj_controller.tabs_visible) {
		...
		global.tab_previous = instance_create_layer(p_cards_x, global.p_inicial_y-17, "buttons", obj_button)
		global.tab_previous.sprite_index = spr_tab
		global.tab_previous.image_angle = -180
		global.tab_previous.goto_next = 0

		global.tab_next = instance_create_layer(p_cards_x+room_width/2.45, global.p_inicial_y-17, "buttons", obj_button)
